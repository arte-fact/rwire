...
pub fn nord() -> ColorPalette {
    ColorPalette {
        neutral: ColorScale::from_hex([
            "#ECEFF4", "#E5E9F0", "#D8DEE9", "#C8CED8", "#B8BFC9", "#A8B0BA", "#6D7A8A", "#4C566A",
            "#434C5E", "#3B4252", "#2E3440", "#242933",
        ]),
        accent: ColorScale::from_hex([
            "#F0F4F8", "#E3EDF5", "#C9DDE9", "#A3C9DC", "#8FBCBB", "#88C0D0", "#81A1C1", "#6E94B4",
            "#5E81AC", "#5476A0", "#4C6B94", "#3D5A80",
        ]),
        red: ColorScale::from_hex([
            "#FDF2F2", "#FAE5E5", "#F5CCCC", "#EBADAD", "#D98E8E", "#C87878", "#BF616A", "#B55760",
            "#A84D56", "#9A444C", "#8C3B42", "#7D3238",
        ]),
        green: ColorScale::from_hex([
            "#F4F8F4", "#E8F0E8", "#D4E4D4", "#BCD6BC", "#A8C8A8", "#96BA96", "#A3BE8C", "#94AE7E",
            "#859E70", "#768E62", "#677E54", "#586E46",
        ]),
        amber: ColorScale::from_hex([
            "#FFFBF0", "#FFF5DC", "#FFECC4", "#FFE0A8", "#F5D08C", "#EBCB8B", "#D9B870", "#C7A55A",
...
pub fn catppuccin() -> ColorPalette {
    ColorPalette {
        neutral: ColorScale::from_hex([
            "#EFF1F5", "#E6E9EF", "#DCE0E8", "#CCD0DA", "#BCC0CC", "#ACB0BE", "#7C7F93", "#6C6F85",
            "#585B70", "#45475A", "#313244", "#1E1E2E",
        ]),
        accent: ColorScale::from_hex([
            "#F5F0FA", "#EDE4F5", "#DCC8EB", "#CBADE1", "#BA91D7", "#AD7FD0", "#CBA6F7", "#B98EEF",
            "#B07BE8", "#A76DDE", "#9D5FD4", "#8839EF",
        ]),
        red: ColorScale::from_hex([
            "#FDF0F0", "#FAE0E0", "#F5C2C2", "#F0A4A4", "#EB8686", "#E56868", "#F38BA8", "#ED6D8D",
            "#E64F73", "#D94258", "#CC3548", "#BF2838",
        ]),
        green: ColorScale::from_hex([
            "#F0F8F0", "#E0F0E0", "#C2E0C2", "#A4D0A4", "#86C086", "#68B068", "#A6E3A1", "#8ED98A",
            "#76CF73", "#5EC55C", "#46BB45", "#2EB12E",
        ]),
        amber: ColorScale::from_hex([
            "#FFF8F0", "#FFF0DC", "#FFE4C0", "#FFD8A0", "#FFCC80", "#FFC060", "#F9E2AF", "#F5D48A",
...
pub fn dracula() -> ColorPalette {
    ColorPalette {
        neutral: ColorScale::from_hex([
            "#F8F8F2", "#ECEEF0", "#D6D9E0", "#C0C4D0", "#A0A4B8", "#808498", "#6272A4", "#555A70",
            "#44475A", "#383A4A", "#2C2E3A", "#282A36",
        ]),
        accent: ColorScale::from_hex([
            "#F8F0FF", "#F0E0FF", "#E0C4FF", "#D0A8FF", "#C08CFF", "#B580F0", "#BD93F9", "#AB80F0",
            "#9A6DE7", "#895ADE", "#7847D5", "#6734CC",
        ]),
        red: ColorScale::from_hex([
            "#FFF0F0", "#FFE0E0", "#FFC2C2", "#FFA4A4", "#FF8686", "#FF7979", "#FF5555", "#EE4444",
            "#DD3333", "#CC2222", "#BB1111", "#AA0000",
        ]),
        green: ColorScale::from_hex([
            "#F0FFF0", "#E0FFE0", "#C2FFC2", "#A4FFA4", "#86FF86", "#68FF68", "#50FA7B", "#40E868",
            "#30D655", "#20C442", "#10B22F", "#00A01C",
        ]),
        amber: ColorScale::from_hex([
            "#FFFFF0", "#FFFFE0", "#FFFFC2", "#FFFFA4", "#FFFF86", "#FFFF68", "#F1FA8C", "#E0E878",
...
pub fn solarized() -> ColorPalette {
    ColorPalette {
        neutral: ColorScale::from_hex([
            "#FDF6E3", "#EEE8D5", "#DDD6C1", "#CCc4AD", "#B8B09A", "#A09A86", "#839496", "#657B83",
            "#586E75", "#475B62", "#073642", "#002B36",
        ]),
        accent: ColorScale::from_hex([
            "#F0FAFA", "#E0F5F5", "#C2EAEA", "#A4DFDF", "#86D4D4", "#6CCAC8", "#2AA198", "#249188",
            "#1E8178", "#187168", "#126158", "#0C5148",
        ]),
        red: ColorScale::from_hex([
            "#FDF2F0", "#FAE4E0", "#F5C8C2", "#F0ACA4", "#EB9086", "#E57468", "#DC322F", "#CC2825",
            "#BC1E1B", "#AC1411", "#9C0A07", "#8C0000",
        ]),
        green: ColorScale::from_hex([
            "#F4FAF0", "#E6F5E0", "#CCE8C2", "#B2DBA4", "#98CE86", "#7EC168", "#859900", "#768A00",
            "#677B00", "#586C00", "#495D00", "#3A4E00",
        ]),
        amber: ColorScale::from_hex([
            "#FFF8F0", "#FFF0DC", "#FFE4C0", "#FFD8A0", "#FFCC80", "#FFC060", "#B58900", "#A67C00",
...
pub fn gruvbox() -> ColorPalette {
    ColorPalette {
        neutral: ColorScale::from_hex([
            "#FBF1C7", "#EBDBB2", "#D5C4A1", "#BDAE93", "#A89984", "#928374", "#7C6F64", "#665C54",
            "#504945", "#3C3836", "#282828", "#1D2021",
        ]),
        accent: ColorScale::from_hex([
            "#FFF0E0", "#FFE0C0", "#FFC490", "#FFA860", "#FF8C40", "#F07830", "#D65D0E", "#C45208",
            "#B24702", "#A03C00", "#8E3100", "#7C2600",
        ]),
        red: ColorScale::from_hex([
            "#FDF0F0", "#FAE0E0", "#F5C4C4", "#F0A8A8", "#EB8C8C", "#E07070", "#CC241D", "#BB1A14",
            "#AA100B", "#990602", "#880000", "#770000",
        ]),
        green: ColorScale::from_hex([
            "#F4FAF0", "#E8F5E0", "#D0E8C4", "#B8DBA8", "#A0CE8C", "#88C170", "#98971A", "#8A8A10",
            "#7C7D06", "#6E7000", "#606300", "#525600",
        ]),
        amber: ColorScale::from_hex([
            "#FFF8E0", "#FFF0C0", "#FFE490", "#FFD860", "#FFCC40", "#F0C030", "#D79921", "#C88C18",
...
pub fn tokyo_night() -> ColorPalette {
    ColorPalette {
        neutral: ColorScale::from_hex([
            "#D5D6DB", "#C0C1C8", "#A9B1D6", "#9AA5CE", "#787C99", "#565F89", "#414868", "#3B4261",
            "#343B59", "#2C3052", "#24283B", "#1A1B26",
        ]),
        accent: ColorScale::from_hex([
            "#F0F4FF", "#E0E8FF", "#C4D4FF", "#A8C0FF", "#8CACFF", "#7EA0FF", "#7AA2F7", "#6890EE",
            "#567EE5", "#446CDC", "#325AD3", "#2048CA",
        ]),
        red: ColorScale::from_hex([
            "#FFF0F0", "#FFE0E0", "#FFC4C4", "#FFA8A8", "#FF8C8C", "#FF7070", "#F7768E", "#EE6478",
            "#E55262", "#DC404C", "#D32E36", "#CA1C20",
        ]),
        green: ColorScale::from_hex([
            "#F0FFF4", "#E0FFE8", "#C4FFCC", "#A8FFB0", "#8CFF94", "#70FF78", "#9ECE6A", "#8CBE5A",
            "#7AAE4A", "#689E3A", "#568E2A", "#447E1A",
        ]),
        amber: ColorScale::from_hex([
            "#FFFFF0", "#FFFFE0", "#FFFFC4", "#FFFFA8", "#FFFF8C", "#FFEE70", "#E0AF68", "#D09E58",
...
pub fn rose_pine() -> ColorPalette {
    ColorPalette {
        neutral: ColorScale::from_hex([
            "#FAF4ED", "#F2E9E1", "#E0D5CB", "#CECACD", "#908CAA", "#6E6A86", "#56526E", "#44415A",
            "#393552", "#2A273F", "#1F1D2E", "#191724",
        ]),
        accent: ColorScale::from_hex([
            "#FFF0F4", "#FFE0E8", "#FFC4CC", "#FFA8B0", "#FF8C94", "#F57E84", "#EB6F92", "#E15D80",
            "#D74B6E", "#CD395C", "#C3274A", "#B91538",
        ]),
        red: ColorScale::from_hex([
            "#FFF0F0", "#FFE0E0", "#FFC4C4", "#FFA8A8", "#FF8C8C", "#F07070", "#EB6F92", "#E05D7E",
            "#D54B6A", "#CA3956", "#BF2742", "#B4152E",
        ]),
        green: ColorScale::from_hex([
            "#F0FAF4", "#E0F5E8", "#C4EACC", "#A8DFB0", "#8CD494", "#70C978", "#9CCFD8", "#88BFC8",
            "#74AFB8", "#609FA8", "#4C8F98", "#387F88",
        ]),
        amber: ColorScale::from_hex([
            "#FFF8F0", "#FFF0E0", "#FFE4C0", "#FFD8A0", "#FFCC80", "#F0C060", "#F6C177", "#EAB567",
...
pub fn one_dark() -> ColorPalette {
    ColorPalette {
        neutral: ColorScale::from_hex([
            "#F0F2F4", "#E0E4E8", "#C8CCD2", "#B0B4BC", "#979DA6", "#7F8590", "#5C6370", "#4B5263",
            "#3E4452", "#353B45", "#282C34", "#21252B",
        ]),
        accent: ColorScale::from_hex([
            "#F0F8FF", "#E0F0FF", "#C0DCFF", "#A0C8FF", "#80B4FF", "#70A8FF", "#61AFEF", "#529EE6",
            "#438DDD", "#347CD4", "#256BCB", "#165AC2",
        ]),
        red: ColorScale::from_hex([
            "#FFF0F0", "#FFE0E0", "#FFC2C2", "#FFA4A4", "#FF8686", "#F07070", "#E06C75", "#D45A62",
            "#C8484F", "#BC363C", "#B02429", "#A41216",
        ]),
        green: ColorScale::from_hex([
            "#F0FAF0", "#E0F5E0", "#C2E8C4", "#A4DBA8", "#86CE8C", "#68C170", "#98C379", "#88B56A",
            "#78A75B", "#68994C", "#588B3D", "#487D2E",
        ]),
        amber: ColorScale::from_hex([
            "#FFF8E8", "#FFF0D0", "#FFE4B0", "#FFD890", "#FFCC70", "#F0C060", "#E5C07B", "#D8B46C",
